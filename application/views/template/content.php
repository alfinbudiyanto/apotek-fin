      ...
      <div class="row">
        <div class="col-12">
              ...
              <table class="table table-hover text-nowrap">
                ...
                <tbody>
                  <tr>
                    ...
                    <td><?= $o->nama; ?></td>
                    <td><?= $o->exp; ?></td>
                    <td><span class="tag tag-success"><?= $o->stok; ?></span></td>
                    <td><?= $o->harga; ?></td>
                </tbody>
                <?php endforeach ?>
              </table>
          ...
          <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <div class="col-sm-12 col-md-6"><div id="example1_filter" class="dataTables_filter"><label>Search:<input type="search" class="form-control form-control-sm" placeholder="Search..." aria-controls="example1"></label></div></div></div><div class="row"><div class="col-sm-12"><table id="example1" class="table table-bordered table-striped dataTable dtr-inline" aria-describedby="example1_info">
                  <thead>
